...
![Wie wurde früher Software entwickelt?](../img/frueher.png)<!-- .element height="75%" width="75%" -->
...
![Cross-funktionale Teams](../img/cross_functional_team.png)<!-- .element height="65%" width="65%" -->

---

### Und was ist mit dem DevOps Engineer?

![DevOps Engineer](../img/devops_engineer.png)<!-- .element height="75%" width="75%" -->

---

### Und was ist mit dem DevOps Engineer?

![DevOps Engineer](../img/monster.png)<!-- .element height="50%" -->
...
![T-Shaped SKill](../img/t-shaped_skill.png)<!-- .element height="25%" width="25%" -->
